...
![alt-текст](_assets/print_pages.png "Блок диалога печати «Блок диалога печати «Страницы» из вкладки «Печать» – разбиение печатаемой области на страницы")
