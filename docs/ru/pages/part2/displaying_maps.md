...
После нажатия на кнопку с изображением руки ![alt-текст](../_assets/but_hand.png) в наборе инструментов на нижней рамке окна Редактора, происходит переход в режим перемещения изображения в окне Редактора, курсор при этом принимает вид указывающей руки ![alt-текст](../_assets/cur_mov_image-hand.png).
...
Дополнительно есть возможность перемещения изображения в окне карты по заданным координатам, для этого выделив кнопку ![alt-текст](../_assets/but_hand.png) и нажав клавишу «С» на клавиатуре появится диалог «Координаты», представленный на рисунке:
