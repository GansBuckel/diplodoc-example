...
![alt-текст](../_assets/but_layers_layer_info.png) — получить информацию о составе слоя (при вызове команды появится запрос, который аналогичен запросу команды «Карта» – «Информация…»);
