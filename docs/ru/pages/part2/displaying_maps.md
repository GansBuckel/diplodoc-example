...
| v              | Крестик напротив поля обозначает, что видимость карты включена (двойной клик левой клавишей мыши напротив поля карты вкл./откл. видимость карты). Нажатие на поле вызывает контекстное меню<br> ![alt-текст](_assets/win_prj_vector_menu_v.png "Команды контекстного меню поля «v»")                                                                                                                                                                                                                         |
...
| v              | Крестик напротив поля обозначает, что видимость файла рельефа включена (двойной клик левой клавишей мыши напротив поля карты вкл./откл. видимость карты). Нажатие на кнопку поля вызывает контекстное меню<br> ![alt-текст](_assets/win_prj_vector_menu_v.png "Команды контекстного меню поля «v»")                                                                                                                                                                                                                         |
