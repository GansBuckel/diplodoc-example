...
Подробнее о Рабочей папке можно прочитать в разделе [«Правила размещения на компьютере»
...
Многостраничное окно «Проект» предназначено для загрузки и выгрузки данных, а так же для управления данными проекта – включение и отключение видимости, получение информации о данных, управление взаимным расположением данных и прочее

![alt-текст](_assets/win_prj_vector_clear.png "Окно управления набором пространственных данных «Проект»")

Горячая клавиша для вызова окна F2. Окно «Проект» состоит из нескольких страниц:
