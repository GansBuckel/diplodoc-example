...
| scale1         | Нижний масштаб отображения, после которого видимость карты отключается (см. описание порогов отображения карт проекта в разделе команды «Проект»–«Редактировать…»). При нажатии на кнопку с названием поля ![alt-текст](../_assets/but_scale1.png) открывается диалог «Масштаб отображения», в котором можно назначить пороги видимости для текущей карты списка проекта ![alt-текст](_assets/scale_dialog.png "Диалог настройки порогов видимости карты проекта для нижнего масштаба отображения (scale1)")  |
| scale2         | Верхний масштаб отображения, после которого видимость карты отключается (см. описание порогов отображения карт проекта в разделе команды «Проект»–«Редактировать…»). При нажатии на кнопку с названием поля ![alt-текст](../_assets/but_scale2.png) открывается диалог «Масштаб отображения», в котором можно назначить пороги видимости для текущей карты списка проекта ![alt-текст](_assets/scale_dialog.png "Диалог настройки порогов видимости карты проекта для нижнего масштаба отображения (scale2)") |
