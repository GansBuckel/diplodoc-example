...
|----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| a              | Крестик напротив поля обозначает, что данная карта активная (двойной клик левой клавишей мыши на пустом поле напротив другой карты делает данную карту активной)                                                                                                                                                                                                                                                                                                                                                     |
| v              | Крестик напротив поля обозначает, что видимость карты включена (двойной клик левой клавишей мыши напротив поля карты вкл./откл. видимость карты). Нажатие на поле вызывает контекстное меню ![alt-текст](_assets/win_prj_vector_menu_v.png "Команды контекстного меню поля «v» (видимость)")                                                                                                                                                                                                                         |
| name           | Название файла векторных данных                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| scale1         | Нижний масштаб отображения, после которого видимость карты отключается (см. описание порогов отображения карт проекта в разделе команды «Проект»–«Редактировать…»). При нажатии на кнопку с названием поля ![alt-текст](../_assets/but_scale1.png) открывается диалог «Масштаб отображения», в котором можно назначить пороги видимости для текущей карты списка проекта ![alt-текст](_assets/but_scale_dialog.png "Диалог настройки порогов видимости карты проекта для нижнего масштаба отображения (scale1)")  |
| scale2         | Верхний масштаб отображения, после которого видимость карты отключается (см. описание порогов отображения карт проекта в разделе команды «Проект»–«Редактировать…»). При нажатии на кнопку с названием поля ![alt-текст](../_assets/but_scale2.png) открывается диалог «Масштаб отображения», в котором можно назначить пороги видимости для текущей карты списка проекта ![alt-текст](../_assets/but_scale_dialog.png "Диалог настройки порогов видимости карты проекта для нижнего масштаба отображения (scale2)") |
...
Подробное описание технологии сшивки фотоплана см. в описании команды функционального «Растр»–«Фотоплан»–«Новый...» в разделе «Операции над растровыми изображениями».
